                     ...
                     <h1 class="heading-line__header">
                        <span class="heading-line__header-text">
                           <?php
                              ...
                              {
                                ?>
                           <p class="text-light">Medium Business 51-999 Employees</p>
                           <?php }
                              ?> 
                           <?php if($main_heading)
                              {
                ...
                <!--<li>
                  ...
                  <div class="select_drop">
                    <select>
                      ...
                      <option value="2019">51-100 Users</option>
                      <option value="2019">101-200 Users</option>
                      <option value="2019">201-300 Users</option>
                      <option value="2019">301-400 Users</option>
                      <option value="2019">401-500 Users</option>
					 <option value="2019">501-600 Users</option>
                      <option value="2019">601-700 Users</option>
                      <option value="2019">701-800Users</option>
                      <option value="2019">801-999 Users</option>
                    </select>
                    <select>
